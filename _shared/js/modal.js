...
(function () {
  ...
  if (!val) return;
  var s = document.createElement('style');
  s.textContent = '@keyframes __sbPageIn{0%{opacity:0;transform:translateY(12px) scale(0.97)}100%{opacity:1;transform:translateY(0) scale(1)}}body{animation:__sbPageIn .32s cubic-bezier(.22,1,.36,1) both}';
